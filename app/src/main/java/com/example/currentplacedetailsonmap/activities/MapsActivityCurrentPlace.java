...
/**
 * An activity_order_details that displays a map showing the place at the device's current location.
 */
...
//
    ...
    /**
     * Saves the state of the map when the activity_order_details is paused.
     */
//    @Override
...
//                    new LatLng(latttitude, longittude)).title("here").snippet("name");
//
...
//                        Geocoder geo = new Geocoder(MapsActivityCurrentPlace.this, Locale.getDefault());
...
////                        }
//
//                        Toast.makeText(MapsActivityCurrentPlace.this, ""+addresses.get(0).getFeatureName() + ", " + addresses.get(0).getLocality() +", " + addresses.get(0).getAdminArea() + ", " + addresses.get(0).getCountryName(), Toast.LENGTH_SHORT).show();
//                    }
//                    else{
//                        Toast.makeText(MapsActivityCurrentPlace.this, "No information for this service", Toast.LENGTH_SHORT).show();
//                    }
//
//
//                }
...
//
////                -1.176398, 36.940231
//                Geocoder geocoder = new Geocoder(MapsActivityCurrentPlace.this, Locale.getDefault());
//                try {
